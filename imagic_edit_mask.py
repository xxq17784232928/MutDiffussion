...
if __name__ == '__main__':
    ...
    # Log input image to TensorBoard
    # tb_writer.add_image('Input Image Reconstructed', transforms.ToTensor()(img))
    ...
    # tb_writer.add_image('Mask', transforms.ToTensor()(mask_))
    ...
    # Log the initial generated image to TensorBoard
    # tb_writer.add_image('Start Image - Target Text', transforms.ToTensor()(img))
    ...
    #保存到tensorboard
    # tb_writer.add_image('Stage 1 Optimization Loss', transforms.ToTensor()(Image.open(os.path.join(save_dir, 'stage1_optimization_loss.png'))))
    ...
    img.save(os.path.join(save_dir, 'A_end_optText_origDM.png'))
     ...
     # Log the optimized image to TensorBoard
    # tb_writer.add_image('End Image - Optimized Text', transforms.ToTensor()(img))
    ...
    # tb_writer.add_image('Stage 2 Fine-Tuning Loss', transforms.ToTensor()(Image.open(os.path.join(save_dir, 'stage2_finetuning_loss.png'))))
    ...
    for idx, alpha in enumerate(args.alpha_list):
        ...
        img = quick_sample(new_emb, scale, start_code)
        img.save(
            os.path.join(save_dir,f'0C_interText_optDM_{idx}_alpha={round(alpha,3)}.png'))
